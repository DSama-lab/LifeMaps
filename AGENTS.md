...
| `test-map.html` | Harness do Mapa Premium (16/16): pins sem duplicação + `project()`, card compacto→full + anel `.sel`, touch-guard, troca de estilo (glyphs CORS-safe, `traj-line` converge), busca, criação/limpeza de item. |
